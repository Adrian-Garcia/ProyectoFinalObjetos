...
class Reserva {
	...
	public:
		...
		void setFechaReserva(Fecha nuevaFecha) {
			fechaReservacion = nuevaFecha;
		}

		//Metodo que despliega los datos de la reserva
		void muestraReserva() {
			cout << "ID Material: " << iIdMaterial << endl;
			cout << "ID Cliente: " << iIdCliente << endl;
			cout <<	"Fecha: ";
			fechaReservacion.muestraFecha();
			cout << endl << endl;
		}
